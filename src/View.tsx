...
export type ViewProps = {
	...
	// Added to update events when ruting changes
	update?: boolean;
};
...
function Container({
	...
	useFrame((state) => {
		...
		if (rect.current) {
			...
			const isOffscreen =
				bottom < 0 || top > canvasSize.height || right < 0 || left > canvasSize.width;
...
export const View = ({ track, index = 1, frames = Infinity, children, update }: ViewProps) => {
